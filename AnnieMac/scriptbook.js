...
$(function() {
	...
	if (window.location.href.indexOf("nmg") != -1) {
		$('#kevindolan .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#landygarcia .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#carolinapolania .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#majourbey .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#stevefisher .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#susanlane .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#michaellettre .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#kellymchale .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#billfoley .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, New Jersey</a></div>" );
		$('#julianabotero .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Miami Lakes, Florida</a></div>" );
		$('#paulpykosh .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Miami Lakes, Florida</a></div>" );
		$('#youssefabdelhalim .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Sparta, New Jersey</a></div>" );
		$('#tomjagger .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Sparta, New Jersey</a></div>" );
		$('#robertlepore .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Sparta, New Jersey</a></div>" );
		$('#kristinaneagu .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Sparta, New Jersey</a></div>" );
		$('#amirelshafiy .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Brooklyn, New York</a></div>" );
	};
