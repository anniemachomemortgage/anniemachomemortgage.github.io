...
$(function() {
	...
	if (window.location.href.indexOf("brooklyn") != -1) {
		$( '<h3 class="text-center">Loan Partners</h3><div id="" class="team-member-section"><div class="team-member" id="javierkato"><div id="" class="team-member-information"><h4>Javier Kato</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait"></div><button class="flex space-between align-center">973-321-7664 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: JKato@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="shaquellajones"><div id="" class="team-member-information"><h4>Shaquella Jones</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait"></div><button class="flex space-between align-center">973-933-6482 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: smjones@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div>' ).appendTo( $( "#team-display" ) );
	}
