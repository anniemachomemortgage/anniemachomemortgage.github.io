...
$(function() {
	...
	if (window.location.href.indexOf("annapolis.annie-mac.com") != -1) {
		$( '<h3 class="text-center">Additional Staff</h3><div id="" class="team-member-section"><div class="team-member" id="marissakalliongis"><div id="" class="team-member-information"><h4>Marissa Kalliongis</h4><h5>Business Development Representative</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://www.annie-mac.com/dev/themes/annie_mac/img/unnamed.png); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 206-4352 Ext. 1503<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: MKalliongis@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="adambaker"><div id="" class="team-member-information"><h4>Adam Baker</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.com/uploads/sites/10713/public/Adam_Headshot.jpeg); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 309-5202 Ext. 1506<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: ABaker@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="kelliesmith"><div id="" class="team-member-information"><h4>Kellie Smith</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.com/uploads/sites/10713/public/Kellie_Headshot.jpeg); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 239-1943 Ext. 1507<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: kmsmith@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="jeffbradford"><div id="" class="team-member-information"><h4>Jeff Bradford</h4><h5>Processor</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.com/uploads/sites/10713/public/Jeff_Headshot.jpeg); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(856) 272-4749 Ext. 4816<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: JBradford@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="brittanibunyea"><div id="" class="team-member-information"><h4>Brittani Bunyea</h4><h5>Jr Processor</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://www.annie-mac.com/dev/themes/annie_mac/img/unnamed.png); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 309-8248 Ext. 1505<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: BBunyea@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div>' ).appendTo( $( "#team-display" ) );
	};
