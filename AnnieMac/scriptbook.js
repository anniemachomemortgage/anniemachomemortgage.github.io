...
$(function() {
	...
	if ((window.location.href.indexOf("themtgco.com") != -1) || (window.location.href.indexOf("themortgageco.wmmortgageware") != -1)) {
		if ($('body').hasClass('site-type-corporate')) {
			...
			var dropteam = '<section id="team-display" class="flex column padding-60" style="margin-top: -60px"><h3 style="text-align: center; font-size: 46px;">Our Team</h3><h3 class="text-center">Branch Management</h3><div id="branch-managers" class="flex justify-center align-center"><div id="" class="branch-manager-section flex"><div class="manager-information" id="steve"><div id="" class="team-member-information"><h4>Steve Stelzman</h4><h5>Mortgage Loan Officer &amp; Branch Manager</h5><h5>NMLS: 134051</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/steve.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"><a href="https://steve.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(610) 216-5547<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: steve@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div></div><h3 class="text-center">Our Sales Team</h3><div id="" class="team-member-section"><div class="team-member" id="beth"><div id="" class="team-member-information"><h4>Beth Tucker</h4><h5>Mortgage Loan Originator</h5><h5>NMLS: 1159576</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/beth-tucker-2018.jpeg); background-size: 81%; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"><a href="https://beth.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(610) 462-9198 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: etucker@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="larry"><div id="" class="team-member-information"><h4>Larry Ahner</h4><h5>Mortgage Loan Originator</h5><h5>NMLS: 535333</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/Larry_Ahrner.jpg); background-size: 88%; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"> <a href="https://larry.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(610) 739-8655 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: lahner@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="gene"><div id="" class="team-member-information"><h4>Eugene Bochniak</h4><h5>Mortgage Loan Originator</h5><h5>NMLS: 403985</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/Eugene_Bochniak-compressed.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"><a href="https://gene.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(484) 951-5434<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: ebochniak@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="greg"><div id="" class="team-member-information"><h4>Greg Reimer</h4><h5>Mortgage Loan Originator</h5><h5>NMLS: 535382</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/Greg_Reimer.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"><a href="https://greg.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(610) 392-4961<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: greimer@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div></section>';
