...
$(function() {
	...
	if (window.location.href.indexOf("davidjones") != -1) {
		$('<span style="text-align: center;">AnnieMac Home Mortgage is not endorsed or sponsored by the United State Department of Veterans Affairs or any government agency.</span>').insertBefore( $( "#sitemap" ) );
