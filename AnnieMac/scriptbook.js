...
$(function() {
	...
	$('.team-member-portrait').each(function() {
		var $this = $(this);
		if ($this.css('background-image').indexOf('/dev/themes/annie_mac/img/unnamed.png') !== -1) {
