...
$(function() {
	...
	if (window.location.href.indexOf("https://louisville") != -1) {
		$("#team-display > div.team-member-section").prepend("<div class='team-member' id='chrissypierson'><div id=' class='team-member-information'><a class='loan-officer-h4-link' href='https://chrissypierson.annie-mac.com'><h4>Chrissy Pierson</h4></a><h5>Mortgage Loan Originator</h5><h5>NMLS: 1412881</h5><a href='https://chrissypierson.annie-mac.com'><div id=' class='team-member-portrait' style='background: url(https://annie-mac.com/uploads/sites/10713/public/ChristinaPierson_Selects_0123.jpeg); background-size: cover; background-position: center center; background-repeat: no-repeat;'><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div></div></a><button class='go flex space-between align-center loan-officer-apply-link'><a href='https://chrissypierson.annie-mac.com/loan/apply' class='btn button-main '>Apply Now</a></button><button class='flex space-between align-center loan-officer-phone'>(513) 769-2038<i class='fas fa-mobile-alt'></i></button><button class='flex space-between align-center loan-officer-email'><a href='mailto: cpierson@annie-mac.com'>Email Me</a><i class='fas fa-envelope'></i></button></div></div>");
		$("<div class='manager-information' id='jamesclaxton'><div id=' class='team-member-information'><a class='loan-officer-h4-link' href='https://jamesclaxton.annie-mac.com'><h4>James Claxton</h4></a><h5>Branch Manager</h5><h5>NMLS: 57332</h5><a href='https://jamesclaxton.annie-mac.com'><div id=' class='team-member-portrait' style='background: url(https://annie-mac.com/uploads/sites/10713/public/Jim_Claxton__3_.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;'><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div><div class='link-to-website-identify'><i class='fas fa-globe-americas'></i></div></div></a><button class='go flex space-between align-center loan-officer-apply-link'><a href='https://jamesclaxton.annie-mac.com/loan/apply' class='btn button-main '>Apply Now</a></button><button class='flex space-between align-center loan-officer-phone'>(5859) 689-8001<i class='fas fa-mobile-alt'></i></button><button class='flex space-between align-center loan-officer-email'><a href='mailto: jclaxton@annie-mac.com'>Email Me</a><i class='fas fa-envelope'></i></button></div></div>").appendTo('.branch-manager-section');
