$(function() {
	...
	if (window.location.href.indexOf("nmg") != -1) {
		$( '<div id="equal-viewing-branches"><h3 class="text-center">Branch Management</h3><div id="" class="team-member-section branches-other-team"><div class="team-member" id="kevindolan"><div id="" class="team-member-information"><a class="loan-officer-h4-link" href="https://kevindolan.annie-mac.com"><h4>Kevin Dolan</h4></a><h5>Area Manager</h5><h5>NMLS: 281162</h5><a href="https://kevindolan.annie-mac.com"><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10713/public/KevinDolan20171.jpeg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div></a><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://netcong.annie-mac.com/" class="btn button-main ">Visit Now</a></button><button class="flex space-between align-center loan-officer-phone">(201) 486-3177</button><button class="flex space-between align-center loan-officer-email"><a href="mailto: kdolan@annie-mac.com">Email Me</a></button></div></div><div class="team-member" id="landygarcia"><div id="" class="team-member-information"><a class="loan-officer-h4-link" href="https://landygarcia.annie-mac.com"><h4>Landy Garcia</h4></a><h5>Area Manager</h5><h5>NMLS: 288241</h5><a href="https://landygarcia.annie-mac.com"><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10713/public/LandyGarcia1.jpeg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div></a><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://netcong.annie-mac.com/" class="btn button-main ">Visit Now</a></button><button class="flex space-between align-center loan-officer-phone">(908) 553-5404</button><button class="flex space-between align-center loan-officer-email"><a href="mailto: lgarcia@annie-mac.com">Email Me</a></button></div></div><div class="team-member" id="youssefabdelhalim"><div id="" class="team-member-information"><a class="loan-officer-h4-link" href="https://youssefabdelhalim.annie-mac.com"><h4>Youssef Abdelhalim</h4></a><h5>Branch Manager</h5><h5>NMLS: 1033013</h5><a href="https://youssefabdelhalim.annie-mac.com"><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10713/public/YoussefAbdelhalim1.jpeg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div></a><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://sparta.annie-mac.com/" class="btn button-main ">Visit Now</a></button><button class="flex space-between align-center loan-officer-phone">(973) 826-5035</button><button class="flex space-between align-center loan-officer-email"><a href="mailto: yabdelhalim@annie-mac.com">Email Me</a></button></div></div></div></div><h3 class="text-center">Branches With Our Team</h3><div id="" class="team-member-section branches-other-team"><div class="team-member" id=""><div id="" class="team-member-information"><h4>Netcong</h4><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://netcong.annie-mac.com/" class="btn button-main ">Visit Now</a></button></div></div><div class="team-member" id=""><div id="" class="team-member-information"><h4>Cranford</h4><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://cranford.annie-mac.com/" class="btn button-main ">Visit Now</a></button></div></div><div class="team-member" id=""><div id="" class="team-member-information"><h4>Sparta</h4><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://sparta.annie-mac.com/" class="btn button-main ">Visit Now</a></button></div></div></div><h3 class="text-center">Other Branches With Our Team</h3><div id="" class="team-member-section branches-other-team"><div class="team-member" id=""><div id="" class="team-member-information"><h4>Miami</h4><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://miamilakes.annie-mac.com/" class="btn button-main ">Visit Now</a></button></div></div><div class="team-member" id=""><div id="" class="team-member-information"><h4>Brooklyn</h4><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://brooklyn.annie-mac.com/" class="btn button-main ">Visit Now</a></button></div></div><div class="team-member" id=""><div id="" class="team-member-information"><h4>Brooklyn</h4><button class="go flex space-between align-center loan-officer-apply-link"><a href="https://brooklyn.annie-mac.com/" class="btn button-main ">Visit Now</a></button></div></div></div><h3 class="text-center">Operations Team</h3><div id="" class="team-member-section branches-other-team"><div class="team-member" id="terryplant"><div id="" class="team-member-information"><h4>Terry Plant</h4><h5>Operations Team Lead</h5><div id="" class="team-member-portrait" style="background: url(https://annie-mac.com/uploads/sites/10713/public/Terry_Plant.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-265-1520 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: TPlant@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="hanifahsanders"><div id="" class="team-member-information"><h4>Hanifah Sanders</h4><h5>Branch Operations Manager</h5><div id="" class="team-member-portrait" style="background: url(https://www.annie-mac.com/uploads/sites/10713/public/Hanifah.png); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">856-505-6709 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: HSanders@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="arianapoore"><div id="" class="team-member-information"><h4>Ariana Poore</h4><h5>Branch Operations Manager</h5><div id="" class="team-member-portrait" style="background: url(https://www.annie-mac.com/uploads/sites/10713/public/Ariana_Update.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-988-2466 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: APoore@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div>' ).appendTo( $( "#nmg-insertion-point" ) );
	};
