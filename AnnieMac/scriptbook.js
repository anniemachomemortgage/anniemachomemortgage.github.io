...
$(function() {
	...
	if (window.location.href.indexOf("netcong") != -1) {
		$( '<h3 class="text-center">Operations Team</h3><div id="" class="team-member-section"><div class="team-member" id="terryplant"><div id="" class="team-member-information"><h4>Terry Plant</h4><h5>Operations Team Lead</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(); background-size: 125%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-265-1520 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: TPlant@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="hanifahsanders"><div id="" class="team-member-information"><h4>Hanifah Sanders</h4><h5>Branch Operations Manager</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(); background-size: 125%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">856-505-6709 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: HSanders@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="arianapoore"><div id="" class="team-member-information"><h4>Ariana Poore</h4><h5>Branch Operations Manager</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(); background-size: 125%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-988-2466 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: APoore@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div><h3 class="text-center">Loan Partners</h3><div id="" class="team-member-section"><div class="team-member" id="aaronnicholas"><div id="" class="team-member-information"><h4>Aaron Nicholas</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(); background-size: 125%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-409-6396 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: ANicholas@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="amandagabriele"><div id="" class="team-member-information"><h4>Amanda Gabriele</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(); background-size: 125%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-265-1525 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: AGabriele@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="darianypena"><div id="" class="team-member-information"><h4>Dariany Peña</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(); background-size: 125%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-370-2071 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: DPena@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="shannonpansini"><div id="" class="team-member-information"><h4>Shannon Pansini</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(); background-size: 125%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-265-1522 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: SPansini@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="valentinaarias"><div id="" class="team-member-information"><h4>Valentina Arias</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(); background-size: 125%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-265-1614 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: VArias@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div>' ).appendTo( $( "#team-display" ) );
