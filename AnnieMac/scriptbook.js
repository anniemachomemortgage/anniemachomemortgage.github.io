...
$(function() {
	...
	if(document.URL.indexOf("/branch") >= 0){ 
		...
		$( locationBranch ).each(function() {
			...
			var subdomain = domain.replace('.annie-mac.com', '').replace('.themtgco.com', '').replace('https://', '').replace('http://', '') + "-branch-listing";
			(this).id = subdomain;
		});
	};
	...
	if (window.location.href.indexOf("miamilakes") != -1) {
		$( '<h3 class="text-center">Loan Partners</h3><div id="" class="team-member-section"><div class="team-member" id="carolinaramos"><div id="" class="team-member-information"><h4>Carolina Ramos</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait"></div><button class="flex space-between align-center">786-206-7473 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: CRamos@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div>' ).appendTo( $( "#team-display" ) );
	}
	if (window.location.href.indexOf("brooklyn") != -1) {
		$( '<h3 class="text-center">Loan Partners</h3><div id="" class="team-member-section"><div class="team-member" id="javierkato"><div id="" class="team-member-information"><h4>Javier Kato</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background: url(https://www.annie-mac.com/uploads/sites/10713/public/Javier.jpg); background-size: cover; background-position-y: 17%; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-321-7664 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: JKato@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="shaquellajones"><div id="" class="team-member-information"><h4>Shaquella Jones</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background: url(https://annie-mac.wmmortgageware.com/uploads/sites/10713/public/Shaq_Jones_Web.jpg); background-size: cover; background-position-y: 28%; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-933-6482 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: smjones@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div>' ).appendTo( $( "#team-display" ) );
	}
	if (window.location.href.indexOf("nmg") != -1) {
		$('#kevindolan .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#landygarcia .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#carolinapolania .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#majourbey .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#stevefisher .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#susanlane .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#michaellettre .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#kellymchale .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#billfoley .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Netcong, NJ</a></div>" );
		$('#julianabotero .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Miami Lakes, FL</a></div>" );
		$('#paulpykosh .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Miami Lakes, FL</a></div>" );
		$('#youssefabdelhalim .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Sparta, NJ</a></div>" );
		$('#tomjagger .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Sparta, NJ</a></div>" );
		$('#robertlepore .team-member-information h5:first-of-type').append( "<div class='teamsitelocationdeclaration'><a href=''>Sparta, NJ</a></div>" );
	...
	if (window.location.href.indexOf("netcong") != -1) {
		$( '<h3 class="text-center">Operations Team</h3><div id="" class="team-member-section"><div class="team-member" id="terryplant"><div id="" class="team-member-information"><h4>Terry Plant</h4><h5>Operations Team Lead</h5><h5></h5><div id="" class="team-member-portrait" style="background: url(https://annie-mac.com/uploads/sites/10713/public/Terry_Plant.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-265-1520 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: TPlant@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="hanifahsanders"><div id="" class="team-member-information"><h4>Hanifah Sanders</h4><h5>Branch Operations Manager</h5><h5></h5><div id="" class="team-member-portrait" style="background: url(https://www.annie-mac.com/uploads/sites/10713/public/Hanifah.png); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">856-505-6709 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: HSanders@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="arianapoore"><div id="" class="team-member-information"><h4>Ariana Poore</h4><h5>Branch Operations Manager</h5><h5></h5><div id="" class="team-member-portrait" style="background: url(https://www.annie-mac.com/uploads/sites/10713/public/Ariana_Update.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-988-2466 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: APoore@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div><h3 class="text-center">Loan Partners</h3><div id="" class="team-member-section"><div class="team-member" id="aaronnicholas"><div id="" class="team-member-information"><h4>Aaron Nicholas</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait"></div><button class="flex space-between align-center">973-409-6396 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: ANicholas@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="amandagabriele"><div id="" class="team-member-information"><h4>Amanda Gabriele</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait"></div><button class="flex space-between align-center">973-265-1525 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: AGabriele@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="darianypena"><div id="" class="team-member-information"><h4>Dariany Peña</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background: url(https://www.annie-mac.com/uploads/sites/10713/public/Dariany_Pena.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-370-2071 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: DPena@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="shannonpansini"><div id="" class="team-member-information"><h4>Shannon Pansini</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background: url(https://www.annie-mac.com/uploads/sites/10713/public/Shannon_Update.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-265-1522 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: SPansini@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="valentinaarias"><div id="" class="team-member-information"><h4>Valentina Arias</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background: url(https://www.annie-mac.com/uploads/sites/10713/public/Valentina_Arias.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="flex space-between align-center">973-265-1614 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: VArias@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div>' ).appendTo( $( "#team-display" ) );
	...
	if (window.location.href.indexOf("https://louisville") != -1) {
		...
		$("#team-display > div.team-member-section").prepend("<div id='' class='team-member'><div id='' class='team-member-information'><a href='http://robertbacon.annie-mac.com/'><h4>Robert Bacon</h4></a><h5>Mortgage Loan Originator</h5><h5>NMLS: 251630</h5><a href='http://robertbacon.annie-mac.com/'><div id='' class='team-member-portrait' style='background: url(https://annie-mac.com/uploads/sites/10713/public/Bob_Bacon.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;'></div></a><button class='go flex space-between align-center'><a href='http://robertbacon.annie-mac.com/loan/apply' class='btn button-main'>Apply Now</button></a><button class='flex space-between align-center'>502-901-2066<i class='fas fa-mobile-alt'></i></button><button class='flex space-between align-center'><a href='mailto: rbacon@annie-mac.com'>Email Me</a><i class='fas fa-envelope'></i></button></div></div>");
	...
	if ((window.location.href.indexOf("themtgco.com") != -1) || (window.location.href.indexOf("themortgageco.wmmortgageware") != -1)) {
		if ($('body').hasClass('site-type-corporate')) {
			...
			var dropteam = '<section id="team-display" class="flex column padding-60" style="margin-top: -60px"><h3 style="color: #006fa9; text-align: center; font-size: 46px;">Our Team</h3><h3 class="text-center">Branch Management</h3><div id="branch-managers" class="flex justify-center align-center"><div id="" class="branch-manager-section flex"><div class="manager-information" id="steve.themtgco.com"><div id="" class="team-member-information"><h4>Steve Stelzman</h4><h5>Mortgage Loan Officer &amp; Branch Manager</h5><h5>NMLS: 134051</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/steve.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"><a href="https://steve.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(610) 216-5547<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: steve@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div></div><h3 class="text-center">Our Sales Team</h3><div id="" class="team-member-section"><div class="team-member" id="beth.themtgco.com"><div id="" class="team-member-information"><h4>Beth Tucker</h4><h5>Mortgage Loan Originator</h5><h5>NMLS: 1159576</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/beth-tucker-2018.jpeg); background-size: 81%; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"><a href="https://beth.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(610) 462-9198 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: etucker@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="larry.themtgco.com"><div id="" class="team-member-information"><h4>Larry Ahner</h4><h5>Mortgage Loan Originator</h5><h5>NMLS: 535333</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/Larry_Ahrner.jpg); background-size: 88%; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"> <a href="https://larry.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(610) 739-8655 <i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: lahner@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="gene.themtgco.com"><div id="" class="team-member-information"><h4>Eugene Bochniak</h4><h5>Mortgage Loan Originator</h5><h5>NMLS: 403985</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/Eugene_Bochniak-compressed.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"><a href="https://gene.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(484) 951-5434<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: ebochniak@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="greg.themtgco.com"><div id="" class="team-member-information"><h4>Greg Reimer</h4><h5>Mortgage Loan Originator</h5><h5>NMLS: 535382</h5><div id="" class="team-member-portrait" style="background: url(/uploads/sites/10839/public/Greg_Reimer.jpg); background-size: cover; background-position: center center; background-repeat: no-repeat;"></div><button class="go flex space-between align-center"><a href="https://greg.themtgco.com" class="btn button-main">More Information</a> <i class="fas fa-globe-americas"></i></button><button class="flex space-between align-center">(610) 392-4961<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: greimer@themtgco.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div></section>';
