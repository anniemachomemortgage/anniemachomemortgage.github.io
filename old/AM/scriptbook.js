$(function() {
	...
	if ($('body').hasClass('site-type-corporate')) {
		var nmlsdropinnavbar = '<span>NMLS 338923</span>';
		$( nmlsdropinnavbar ).appendTo( $( "#navigation_new_upper > div:nth-child(1) > li") );
	...
	if (window.location.href.indexOf("joeybarrow.annie-mac") != -1) {
		$("#testimonials a").attr('href', 'https://tylerbarrow.annie-mac.com/testimonials');
	}
	...
	if (window.location.href.indexOf("annapolis.annie-mac.com") != -1) {
		$( '<h3 class="text-center">Additional Staff</h3><div id="" class="team-member-section"><div class="team-member" id="marissakalliongis"><div id="" class="team-member-information"><h4>Marissa Kalliongis</h4><h5 style="line-height: 30px; font-size: 10px;">Business Development Representative</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.com/uploads/sites/10713/public/Marissa_Headshot.jpg); background-size: 100%; background-position-y: 19% !important; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 206-4352 x1503<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: MKalliongis@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="adambaker"><div id="" class="team-member-information"><h4>Adam Baker</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.com/uploads/sites/10713/public/Adam_Headshot.jpeg); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 309-5202 x1506<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: ABaker@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="kelliesmith"><div id="" class="team-member-information"><h4>Kellie Smith</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.com/uploads/sites/10713/public/Kellie_Headshot.jpeg); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 239-1943 x1507<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: kmsmith@annie-mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="davidgruner"><div id="" class="team-member-information"><h4>David Gruner</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.wmmortgageware.com/uploads/sites/10713/public/DavidGruner.jpg); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 309-8268<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: DGruner@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="jennastrickland"><div id="" class="team-member-information"><h4>Jenna Strickland</h4><h5>Loan Partner</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.wmmortgageware.com/uploads/sites/10713/public/JennaStrickland.jpg); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 777-1270<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: JStrickland@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="jeffbradford"><div id="" class="team-member-information"><h4>Jeff Bradford</h4><h5>Processor</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.com/uploads/sites/10713/public/Jeff_Headshot.jpeg); background-size: 104%; background-position: center -7px; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(856) 272-4749<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: JBradford@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div><div class="team-member" id="brittanibunyea"><div id="" class="team-member-information"><h4>Brittani Bunyea</h4><h5>Processor</h5><h5></h5><div id="" class="team-member-portrait" style="background-image: url(https://annie-mac.com/uploads/sites/10713/public/Brittany_Headshot.jpg); background-size: 111%; background-position: center -7px; background-position-y: 25% !important; background-repeat: no-repeat;"></div><button class="flex space-between align-center">(667) 309-8248 x1505<i class="fas fa-mobile-alt"></i></button><button class="flex space-between align-center"><a href="mailto: BBunyea@Annie-Mac.com">Email Me</a><i class="fas fa-envelope"></i></button></div></div></div>' ).appendTo( $( "#team-display" ) );
	};
	...
	if (window.location.href.indexOf("kimgasca.annie-mac.com") != -1) {
		$( "<h3 style='font-size: 34px; margin: 0; display: block; text-align: left; font-family: inter,sans-serif; text-transform: uppercase; font-weight: 200; letter-spacing: .55px;'>Kim's Team</h3><div class='team-member-section' style='margin: 0;'><div class='team-member' id=''><div id='' class='team-member-information'><h4>Sandra Fossett</h4><h5>MORTGAGE LOAN ORIGINATOR</h5><h5>NMLS: 1695045</h5><div id='' class='team-member-portrait' style='background: transparent; background-image: url(https://annie-mac.com/uploads/sites/10713/public/sandra_fossett__2_.jpg); background-size: cover; background-position: center -7px; background-repeat: no-repeat;'></div><button class='go flex space-between align-center loan-officer-apply-link'><a href='https://chrisgasca.annie-mac.com/loan/apply' class='btn button-main'>Apply Now</a></button><button class='flex space-between align-center'>(817) 405-6095<i class='fas fa-mobile-alt'></i></button><button class='flex space-between align-center'><a href='mailto: teamgasca@annie-mac.com'>Email Me</a><i class='fas fa-envelope'></i></button></div></div><div class='team-member' id=''><div id='' class='team-member-information'><h4>Chris Gasca</h4><h5>SALES MANAGER</h5><h5>NMLS: 260950</h5><div id='' class='team-member-portrait' style='background: transparent; background-image: url(https://annie-mac.com/dev/themes/annie_mac/img/unnamed.png); background-size: cover; background-position: center -7px; background-repeat: no-repeat;'></div><button class='go flex space-between align-center loan-officer-apply-link'><a href='https://sandrafossett.annie-mac.com/loan/apply' class='btn button-main'>Apply Now</a></button><button class='flex space-between align-center'>(817) 405-6095<i class='fas fa-mobile-alt'></i></button><button class='flex space-between align-center'><a href='mailto: teamgasca@annie-mac.com'>Email Me</a><i class='fas fa-envelope'></i></button></div></div></div><h3 style='margin-top: 40px'>Kim's Accolades:</h3><div style='width: 400px; display: flex; justify-content: space-between; padding: 15px 0;'><img src='https://annie-mac.wmmortgageware.com/uploads/sites/10713/public/2022_Top_Originators_License.png' style='width: 175px; height: auto; margin-bottom: 50px; margin-top: 25px;'> <img src='https://annie-mac.wmmortgageware.com/uploads/sites/10713/public/AM_Presidents_Club_Logo_EVO_Winner.png' style='width: 160px; height: auto; margin-bottom: 50px; margin-top: 25px;'></div>").prependTo( $( "#we-provide-more-master" ) );
	};
	...
	if (window.location.href.indexOf("/get-elevated?r=olivia") != -1) {
		...
		$("#bdm-title-phone").text("856-287-6734");
		$("#bdm-title-phone").attr("href", "tel:856-287-6734");
		$("#number-id").attr("href", "tel:856-287-6734");
		$("#number-id").text("856-287-6734");
		...
		$("#booking-id").attr("href", "https://outlook.office365.com/owa/calendar/OliviaBacino1@annie-mac.com/bookings/");
	};
	...
	// Chris Morgan
	if (window.location.href.indexOf("/get-elevated?r=chris") != -1) {
		$("#bdm-avatar").css('background', 'url("https://annie-mac.wmmortgageware.com/uploads/sites/10713/public/chris-morgan.png")');
		$("#bdm-avatar").css('background-size', 'cover');
		$("#bdm-title-name").text("Chris Morgan");
		$("#bdm-title-title").text("National Business Development Manager");
		$("#bdm-title-email").text("CMorgan@Annie-Mac.com");
		$("#bdm-title-email").attr("href", "mailto:CMorgan@Annie-Mac.com");
		$("#bdm-title-phone").text("704-881-4741");
		$("#bdm-title-phone").attr("href", "tel:704-881-4741");
		$("#number-id").attr("href", "tel:704-881-4741");
		$("#number-id").text("704-881-4741");
		$("#UserId").attr('value', "U6UJ9A00057A");
		$("#toggle-captcha").click(function(){
			$("#form-content").fadeOut(2500);
			setTimeout(function(){
			   window.location.href='./get-more-thanks?r=chris';
			  } ,2750);
		});
		$("#download-id-1").attr("href", "https://annie-mac.com/getmore-chris");
		$("#download-id-2").attr("href", "https://annie-mac.com/getmore-chris");
		$("#booking-id").attr("href", "https://outlook.office365.com/owa/calendar/bk_cmorgan@annie-mac.com/bookings/");
	};
	if (window.location.href.indexOf("/get-more-thanks?r=chris") != -1) {
		$("#bdm-avatar").css('background', 'url("https://annie-mac.wmmortgageware.com/uploads/sites/10713/public/chris-morgan.png")');
		$("#bdm-avatar").css('background-size', 'cover');
		$("#bdm-title-name").text("Chris Morgan");
		$("#bdm-title-title").text("National Business Development Manager");
